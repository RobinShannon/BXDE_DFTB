...
contains
  ...
  subroutine derivative_nonSCC(deriv, DM, EDM, skHamCont, skOverCont, coords, &
    ...
    do iAtom1 = 1, nAtom
      ...
      do iNeigh = 1, nNeighbor(iAtom1)
        ...
        if (iAtom1 /= iAtom2f) then
          ...
          !! in the blocks, and also the skew symmetry in the derivatives
          do ii = 1, 3
  ...
  subroutine derivative_block(deriv, DM, EDM, skHamCont, skOverCont,coords,&
  ...
  subroutine derivative_iBlock(deriv, DM, iDM, EDM,skHamCont,skOverCont,coords,&
    ...
    complex(dp) :: sqrDMTmp(orb%mOrb,orb%mOrb)
