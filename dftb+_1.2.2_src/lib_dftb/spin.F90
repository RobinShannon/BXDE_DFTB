...
contains
  ...
  !!* @param specie Species of each atom
  !!* @param orb  Information about the orbitals and their angular momenta
  !!* @param ww Spin coupling constants.
  !!* @todo Add more asserts
  subroutine addSpinShift(shift,chargePerShell,species,orb,ww)
  ...
  subroutine Spin_getOrbitalEquiv(orb, specie, equiv)
    type(TOrbitals), intent(in) :: orb
