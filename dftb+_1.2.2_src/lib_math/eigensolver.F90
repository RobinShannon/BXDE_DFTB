...
!!* in the code
!!* @todo ewevge, Zoltan Hajnal's relatively robus solver and non-Hermitian !'
!!* generalised solvers
...
#include "assert.h"
    ...
    integer :: ii, jj
    character :: uplo_new
    external slamch, spotrf, ssyevr, ssygst, strmm, strsm, xerbla
...
#include "assert.h"
    ...
    integer :: ii, jj
    character :: uplo_new
    external dlamch, dpotrf, dsyevr, dsygst, dtrmm, dtrsm, xerbla
...
#include "assert.h"
    ...
    integer :: ii, jj
    character :: uplo_new
    external SLAMCH, CPOTRF, CHEEVR, CHEGST, CTRMM, CTRSM, XERBLA
...
#include "assert.h"
    ...
    integer :: ii, jj
    character :: uplo_new
    external DLAMCH, ZPOTRF, ZHEEVR, ZHEGST, ZTRMM, ZTRSM, XERBLA
