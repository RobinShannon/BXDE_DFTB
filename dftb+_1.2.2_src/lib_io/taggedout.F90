...
# include "assert.h"
  ...
  character(*), parameter, public :: tag_specie     = 'species'
  character(*), parameter, public :: tag_mAngSpecie = 'angular_momenta'
  ...
  character(*), parameter, public :: tag_stressVirial = 'virial_stress'
  ...
  character(*), parameter, public :: tag_efermi     = 'fermi_energy'
